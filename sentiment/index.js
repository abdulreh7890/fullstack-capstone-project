...
app.post('/sentiment', async (req, res) => {
    ...
    // Task 4: Extract the sentence parameter from query
    ...
    // Initialize the sentiment analyzer with Natural's
    // PorterStemmer and English language
    ...
    try {
        ...
        // Task 6: Return successful response
        res.status(200).json({
